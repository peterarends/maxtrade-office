    ...
    <div class="flex-grow">
        <div class="hero container mx-auto flex flex-col sm:flex-row justify-between py-4 sm:py-12">
            <div class="w-full sm:w-3/5 text-center sm:text-left">
                <div class="text-4xl font-bold">{{ __('MaxtradeOffice') }}</div>
                <div class="text-2xl font-bold text-blue-700">{{ __('Simple Projects & Tasks Manager') }}</div>
    ...
    <footer class="bg-blue-700 text-white py-4">
        <div class="container mx-auto flex flex-col sm:flex-row items-center justify-between">
            ...
            <ul class="flex items-center mx-auto sm:mx-0">
                <li class="px-4">
                    <a href="https://avalonbg.com" class="hover:text-gray-600" target="_blank" title="{{ __('Powered by Avalon') }}">
                        <i class="mdi mdi-alpha-a-circle text-4xl"></i>
                    </a>
                </li>
                <li class="px-4">
                    <a href="https://www.facebook.com/AvalonLtd" class="hover:text-gray-600" target="_blank" title="{{ __('Follow us on Facebook') }}">
                        <i class="mdi mdi-facebook text-4xl"></i>
                    </a>
                </li>
                <li class="px-4">
                    <a href="https://www.youtube.com/channel/UCk_GQ6HDBdWHoK2SaVfkuwA" class="hover:text-gray-600" target="_blank"
                    title="{{ __('Follow us on YouTube') }}">
                        <i class="mdi mdi-youtube text-4xl"></i>
                    </a>
                </li>
                <li class="px-4">
                    <a href="" target="_blank" class="hover:text-gray-600" title="{{ __('Send Us e-mail') }}">
