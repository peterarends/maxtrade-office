...
<div class="text-gray-800 leading-normal flex flex-col min-h-screen">
    ...
    <div class="flex-grow">
        ...
        <div class="container mx-auto flex flex-col sm:flex-row pt-6 sm:pt-0 pb-6 sm:pb-0 justify-between">
            <a href="{{ route('login') }}" class="w-auto sm:w-2/5 m-4 sm:m-0 py-2 px-3 text-3xl text-center bg-gray-400 uppercase rounded font-bold
            text-blue-700">
                {{ __('Login') }}
            </a>
            <a href="{{ route('register') }}" class="w-auto sm:w-2/5 m-4 sm:m-0 py-2 px-3 text-3xl text-center bg-gray-400 uppercase rounded font-bold
            text-blue-700">
                {{ __('Register') }}
            </a>
        </div>
