                            ...
                            <ul>
                                ...
                                <li class="has-sub">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a><span>Completed Tasks</span></a>
                                        </li>
                                        <li>
                                            <a><span>Actived Tasks</span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="has-sub">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a><span>Date Ascending</span></a>
                                        </li>
                                        <li>
                                            <a><span>Date Descending</span></a>
                                        </li>
                                        <li>
                                            <a><span>Status Completed</span></a>
                                        </li>
                                        <li>
                                            <a><span>Status Active</span></a>
                                        </li>
                                        <li>
