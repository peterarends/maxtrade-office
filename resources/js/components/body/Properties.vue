<template>
  <div class="properties-body">
    ...
    <div class="body">
      ...
      <ul>
        <li v-for="category in getPropertyCategories" :key="category.category">
          <h4 class="property_section">{{ category.category }} {{ t("properties") }}</h4>
          <ul>
            <li
              class="property_row"
...
export default {
  ...
  computed: mapGetters(["getTheme", "getProperties", "getPropertyCategories"]),
