<template>
  <div class="emails-body">
    ...
    <div class="body">
      ...
      <div class="html" :class="getTheme">{{ getImap.html }}</div>
    </div>
    <div class="bottom" :class="getTheme">
      <a @click.prevent="newProjectImap" v-if="getCurrentImapId != 0">
        <i class="mdi mdi-chevron-double-left mdiProjectIcon" :class="getTheme"></i>
        <i class="mdi mdi-alpha-p-box mdiProjectIcon" :class="getTheme"></i>
        &nbsp;{{ t("New Project") }}
      </a>
      <a @click.prevent="newTaskImap" v-if="getCurrentImapId != 0 && getCurrentProjectId != 0">
        <i class="mdi mdi-chevron-double-left mdiProjectIcon" :class="getTheme"></i>
        <i class="mdi mdi-alpha-t-box mdiProjectIcon" :class="getTheme"></i>
        &nbsp;{{ t("New Task") }}
      </a>
      <a @click.prevent="currentTaskImap" v-if="getCurrentImapId != 0 && getCurrentTaskId != 0">
        <i class="mdi mdi-chevron-double-left mdiProjectIcon" :class="getTheme"></i>
        <i class="mdi mdi-alpha-c-box mdiProjectIcon" :class="getTheme"></i>
        &nbsp;{{ t("To Current Task") }}
      </a>
      <a @click.prevent="deleteImap">
        <i class="mdi mdi-delete-outline mdiProjectIcon" :class="getTheme"></i>
        &nbsp;{{ t("Delete") }}
      </a>
      <a @click.prevent="closePanel">
        <i class="mdi mdi-close-outline mdiProjectIcon" :class="getTheme"></i>&nbsp;Close
      </a>
