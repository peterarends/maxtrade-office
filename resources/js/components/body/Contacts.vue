  ...
  <div class="address-body">
    ...
    <div class="bottom" :class="getTheme">
      ...
      <a @click.passive="addContactLocal">
        <i class="mdi mdi-plus-circle-outline mdiProjectIcon" v-bind:class="getTheme"></i>&nbsp;Add
      </a>
      <a @click.prevent="defelteContactLocal">
        <i class="mdi mdi-delete-outline mdiProjectIcon" :class="getTheme"></i>&nbsp;Delete
      </a>
  ...
  methods: {
    ...
    defelteContactLocal() {
      if (this.getCurrentContact.id != null) {
        if (
          confirm(this.$translate.text("Do you want to delete the contact?"))
        ) {
          this.deleteContact();
        }
      }
